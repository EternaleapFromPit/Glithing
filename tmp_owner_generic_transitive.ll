...
%glitch.Box__g1__t0 = type { i64, ptr }
%glitch.Box_int___g0__t0 = type { i64, ptr }
...
@.str.0 = private unnamed_addr constant { i64, i64, [4 x i8] } { i64 1000000000, i64 3, [4 x i8] c"Ada\00" }
@.str.1 = private unnamed_addr constant { i64, i64, [4 x i8] } { i64 1000000000, i64 3, [4 x i8] c"404\00" }
...
define ptr @Box__g1__t0_Inner__g1(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
...
define ptr @Box__g1__t0_Outer__g1(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
  ...
  %t2 = load ptr, ptr %t0
  %t3 = load ptr, ptr %t1
  %t4 = call ptr @Box__g1__t0_Inner__g1(ptr %t2, ptr %t3)
...
entry:
  ...
  %t2 = getelementptr %glitch.Box_int___g0__t0, ptr null, i32 1
  %t3 = ptrtoint ptr %t2 to i64
  %t4 = call ptr @glitch_calloc(i64 1, i64 %t3)
  %t5 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t4, i32 0, i32 0
  store i64 1, ptr %t5
  %t6 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t4, i32 0, i32 1
  store ptr @glitch_destroy_Box_int___g0__t0, ptr %t6
  %t7 = load ptr, ptr %t0
  call void @glitch_drop_Box_int___g0__t0(ptr %t7)
  store ptr %t4, ptr %t0
  %t8 = load ptr, ptr %t0
  %t9 = call ptr @Box__g1__t0_Outer__g1__owner_int__string(ptr %t8, ptr getelementptr inbounds ({ i64, i64, [4 x i8] }, ptr @.str.0, i32 0, i32 2, i64 0))
...
call_continue_0:
  ...
  store ptr %t9, ptr %t1
  %t13 = load ptr, ptr %t1
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([4 x i8], ptr @.fmt_str, i64 0, i64 0), ptr %t13)
  %t14 = load ptr, ptr %t1
  ...
  br i1 %t23, label %report_leaks_1, label %main_return_2
report_leaks_1:
...
exception_unwind:
  ...
  %t25 = load ptr, ptr %t0
  call void @glitch_drop_Box_int___g0__t0(ptr %t25)
  %t26 = load atomic i64, ptr @glitch_live_allocations seq_cst, align 8
  %t27 = icmp ne i64 %t26, 0
  %t28 = load ptr, ptr @glitch_exception_pending
  %t29 = icmp ne ptr %t28, null
  %t30 = or i1 %t27, %t29
  %t31 = zext i1 %t30 to i32
  %t32 = call ptr @getenv(ptr @.env_report_leaks)
  %t33 = icmp ne ptr %t32, null
  br i1 %t33, label %report_leaks_3, label %main_return_4
report_leaks_3:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([6 x i8], ptr @.fmt_i64, i64 0, i64 0), i64 %t26)
  br label %main_return_4
main_return_4:
  ret i32 %t31
}

define ptr @Box__g1__t0_Inner__g1__owner_int(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
...
define ptr @Box__g1__t0_Outer__g1__owner_int(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
...
define ptr @Box__g1__t0_Outer__g1__owner_int__string(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
  ...
  %t2 = load ptr, ptr %t0
  %t3 = load ptr, ptr %t1
  %t4 = call ptr @Box__g1__t0_Inner__g1__string(ptr %t2, ptr %t3)
  %t5 = load ptr, ptr @glitch_exception_pending
  %t6 = icmp ne ptr %t5, null
  br i1 %t6, label %exception_unwind, label %call_continue_0
call_continue_0:
...
define ptr @Box__g1__t0_Inner__g1__string(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
