...
define ptr @Box__g1__t0_Echo__g1(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
...
entry:
  ...
  store ptr %t4, ptr %t0
  %t8 = load ptr, ptr %t0
  %t9 = call ptr @Box__g1__t0_Echo__g1__owner_int(ptr %t8, ptr getelementptr inbounds ({ i64, i64, [4 x i8] }, ptr @.str.0, i32 0, i32 2, i64 0))
...
define ptr @Box__g1__t0_Echo__g1__owner_int(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
