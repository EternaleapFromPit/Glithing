...
%glitch.Box_T___g0__t0 = type { i64, ptr, ptr }
...
define void @glitch_destroy_Box_T___g0__t0(ptr %object) {
entry:
  call void @glitch_free(ptr %object)
  ret void
}

define void @glitch_retain_Box_T___g0__t0(ptr %object) {
entry:
  %is_null = icmp eq ptr %object, null
  br i1 %is_null, label %done, label %retain
retain:
  %rc_ptr = getelementptr inbounds %glitch.Box_T___g0__t0, ptr %object, i32 0, i32 0
  %rc = load i64, ptr %rc_ptr
  %next = add i64 %rc, 1
  store i64 %next, ptr %rc_ptr
  br label %done
...
define void @glitch_drop_Box_T___g0__t0(ptr %object) {
entry:
  %is_null = icmp eq ptr %object, null
  br i1 %is_null, label %done, label %release
release:
  ...
  br i1 %destroy, label %destroy_object, label %keep
destroy_object:
  %drop_ptr_ptr = getelementptr inbounds %glitch.Box_T___g0__t0, ptr %object, i32 0, i32 1
  %drop_ptr = load ptr, ptr %drop_ptr_ptr
  %has_dynamic_drop = icmp ne ptr %drop_ptr, null
  br i1 %has_dynamic_drop, label %dynamic_drop, label %static_drop
dynamic_drop:
  ...
  br label %done
static_drop:
  call void @glitch_destroy_Box_T___g0__t0(ptr %object)
  br label %done
keep:
  store i64 %next, ptr %rc_ptr
  br label %done
...
entry:
  ...
  %t2 = load ptr, ptr %t0
  %t3 = getelementptr inbounds %glitch.Box_T___g0__t0, ptr %t2, i32 0, i32 2
  %t4 = load ptr, ptr %t1
  store ptr %t4, ptr %t3
  ret void
exception_unwind:
...
entry:
  ...
  store ptr %this, ptr %t0
  %t1 = load ptr, ptr %t0
  %t2 = getelementptr inbounds %glitch.Box_T___g0__t0, ptr %t1, i32 0, i32 2
  %t3 = load ptr, ptr %t2
  ret ptr %t3
exception_unwind:
  ret ptr null
...
entry:
  ...
  %t1 = getelementptr %glitch.Box_int___g0__t0, ptr null, i32 1
  %t2 = ptrtoint ptr %t1 to i64
  %t3 = call ptr @glitch_calloc(i64 1, i64 %t2)
  %t4 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t3, i32 0, i32 0
  store i64 1, ptr %t4
  %t5 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t3, i32 0, i32 1
  store ptr @glitch_destroy_Box_int___g0__t0, ptr %t5
  %t6 = trunc i64 42 to i32
  call void @Box__g1__t0_ctor__owner_int(ptr %t3, i32 %t6)
  %t7 = load ptr, ptr @glitch_exception_pending
  %t8 = icmp ne ptr %t7, null
  br i1 %t8, label %exception_unwind, label %call_continue_0
call_continue_0:
  %t9 = load ptr, ptr %t0
  call void @glitch_drop_Box_int___g0__t0(ptr %t9)
  store ptr %t3, ptr %t0
  %t10 = load ptr, ptr %t0
  %t11 = call i32 @Box__g1__t0_Get__g0__owner_int(ptr %t10)
  %t12 = load ptr, ptr @glitch_exception_pending
  %t13 = icmp ne ptr %t12, null
  br i1 %t13, label %exception_unwind, label %call_continue_1
call_continue_1:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([4 x i8], ptr @.fmt_i32, i64 0, i64 0), i32 %t11)
  %t14 = load ptr, ptr %t0
  call void @glitch_drop_Box_int___g0__t0(ptr %t14)
  %t15 = call i64 @GlitchLiveAllocations_Load()
  %t16 = icmp ne i64 %t15, 0
  %t17 = load ptr, ptr @glitch_exception_pending
  %t18 = icmp ne ptr %t17, null
  %t19 = or i1 %t16, %t18
  %t20 = zext i1 %t19 to i32
  %t21 = call ptr @getenv(ptr @.env_report_leaks)
  %t22 = icmp ne ptr %t21, null
  br i1 %t22, label %report_leaks_2, label %main_return_3
report_leaks_2:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([6 x i8], ptr @.fmt_i64, i64 0, i64 0), i64 %t15)
  br label %main_return_3
main_return_3:
  ret i32 %t20
exception_unwind:
  %t23 = load ptr, ptr %t0
  call void @glitch_drop_Box_int___g0__t0(ptr %t23)
  %t24 = call i64 @GlitchLiveAllocations_Load()
  %t25 = icmp ne i64 %t24, 0
  %t26 = load ptr, ptr @glitch_exception_pending
  %t27 = icmp ne ptr %t26, null
  %t28 = or i1 %t25, %t27
  %t29 = zext i1 %t28 to i32
  %t30 = call ptr @getenv(ptr @.env_report_leaks)
  %t31 = icmp ne ptr %t30, null
  br i1 %t31, label %report_leaks_4, label %main_return_5
report_leaks_4:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([6 x i8], ptr @.fmt_i64, i64 0, i64 0), i64 %t24)
  br label %main_return_5
main_return_5:
  ret i32 %t29
}

define void @Box__g1__t0_ctor__owner_T(ptr %this, ptr %value) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
...
define ptr @Box__g1__t0_Get__g0__owner_T(ptr %this) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = load ptr, ptr %t0
...
entry:
  ...
  %t2 = load ptr, ptr %t0
  %t3 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t2, i32 0, i32 2
  %t4 = load i32, ptr %t1
  store i32 %t4, ptr %t3
  ret void
exception_unwind:
...
entry:
  ...
  store ptr %this, ptr %t0
  %t1 = load ptr, ptr %t0
  %t2 = getelementptr inbounds %glitch.Box_int___g0__t0, ptr %t1, i32 0, i32 2
  %t3 = load i32, ptr %t2
  ret i32 %t3
exception_unwind:
  ret i32 0
