...
%glitch.NumberAlgorithmsTests__g0__t57 = type { i64, ptr }
...
entry:
  %t0 = getelementptr %glitch.NumberAlgorithmsTests__g0__t57, ptr null, i32 1
  %t1 = ptrtoint ptr %t0 to i64
  %t2 = call ptr @glitch_calloc(i64 1, i64 %t1)
  %t3 = getelementptr inbounds %glitch.NumberAlgorithmsTests__g0__t57, ptr %t2, i32 0, i32 0
  store i64 1, ptr %t3
  %t4 = getelementptr inbounds %glitch.NumberAlgorithmsTests__g0__t57, ptr %t2, i32 0, i32 1
  store ptr @glitch_destroy_NumberAlgorithmsTests__g0__t57, ptr %t4
  call void @NumberAlgorithmsTests__g0__t57_BubbleSort_OrdersValues__g0(ptr %t2)
  %t5 = load ptr, ptr @glitch_exception_pending
  %t6 = icmp ne ptr %t5, null
  br i1 %t6, label %exception_unwind, label %call_continue_0
call_continue_0:
  call void @glitch_drop_NumberAlgorithmsTests__g0__t57(ptr %t2)
...
@.str.28 = private unnamed_addr constant { i64, i64, [4 x i8] } { i64 1000000000, i64 3, [4 x i8] c"404\00" }
...
entry:
  ...
  %field_2 = load ptr, ptr %field_2_ptr
  %t21 = icmp eq ptr %field_2, null
  br i1 %t21, label %array_release_done_10, label %array_release_9
array_release_9:
  %t22 = getelementptr inbounds %glitch.array, ptr %field_2, i32 0, i32 0
  %t24 = getelementptr inbounds %glitch.array, ptr %field_2, i32 0, i32 1
...
element_drop_loop_11:
  ...
  br i1 %t28, label %element_drop_body_12, label %element_drop_done_13
element_drop_body_12:
  %t29 = getelementptr inbounds ptr, ptr %t25, i64 %t27
  %t30 = load ptr, ptr %t29
  call void @glitch_drop_object__g0__t14(ptr %t30)
  %t31 = add i64 %t27, 1
...
element_drop_done_13:
  ...
  br label %array_release_done_10
array_release_done_10:
  call void @glitch_free(ptr %object)
  ret void
}
...
define void @glitch_destroy_NumberAlgorithmsTests__g0__t57(ptr %object) {
entry:
  call void @glitch_free(ptr %object)
  ret void
}

define void @glitch_retain_NumberAlgorithmsTests__g0__t57(ptr %object) {
entry:
  %is_null = icmp eq ptr %object, null
  br i1 %is_null, label %done, label %retain
retain:
  %rc_ptr = getelementptr inbounds %glitch.NumberAlgorithmsTests__g0__t57, ptr %object, i32 0, i32 0
  %rc = load i64, ptr %rc_ptr
  %next = add i64 %rc, 1
  store i64 %next, ptr %rc_ptr
  br label %done
...
define void @glitch_drop_NumberAlgorithmsTests__g0__t57(ptr %object) {
entry:
  %is_null = icmp eq ptr %object, null
  br i1 %is_null, label %done, label %release
release:
  ...
  br i1 %destroy, label %destroy_object, label %keep
destroy_object:
  %drop_ptr_ptr = getelementptr inbounds %glitch.NumberAlgorithmsTests__g0__t57, ptr %object, i32 0, i32 1
  %drop_ptr = load ptr, ptr %drop_ptr_ptr
  %has_dynamic_drop = icmp ne ptr %drop_ptr, null
  br i1 %has_dynamic_drop, label %dynamic_drop, label %static_drop
dynamic_drop:
  ...
  br label %done
static_drop:
  call void @glitch_destroy_NumberAlgorithmsTests__g0__t57(ptr %object)
  br label %done
keep:
  store i64 %next, ptr %rc_ptr
  br label %done
...
entry:
  ...
  %field_4 = load ptr, ptr %field_4_ptr
  %t32 = icmp eq ptr %field_4, null
  br i1 %t32, label %array_release_done_15, label %array_release_14
array_release_14:
  %t33 = getelementptr inbounds %glitch.array, ptr %field_4, i32 0, i32 0
  %t35 = getelementptr inbounds %glitch.array, ptr %field_4, i32 0, i32 1
...
element_drop_loop_16:
  ...
  %t39 = icmp ult i64 %t38, %t34
  br i1 %t39, label %element_drop_body_17, label %element_drop_done_18
element_drop_body_17:
  %t40 = getelementptr inbounds ptr, ptr %t36, i64 %t38
  %t41 = load ptr, ptr %t40
  call void @glitch_drop_ParameterInfo__g0__t6(ptr %t41)
  %t42 = add i64 %t38, 1
...
element_drop_done_18:
  ...
  call void @glitch_free(ptr %field_4)
  br label %array_release_done_15
array_release_done_15:
...
entry:
  ...
  %field_7 = load ptr, ptr %field_7_ptr
  %t43 = icmp eq ptr %field_7, null
  br i1 %t43, label %array_release_done_20, label %array_release_19
array_release_19:
  %t44 = getelementptr inbounds %glitch.array, ptr %field_7, i32 0, i32 0
  %t46 = getelementptr inbounds %glitch.array, ptr %field_7, i32 0, i32 1
  %t45 = load i64, ptr %t44
  %t47 = load ptr, ptr %t46
  call void @glitch_free(ptr %t47)
  call void @glitch_free(ptr %field_7)
  br label %array_release_done_20
array_release_done_20:
  %field_9_ptr = getelementptr inbounds %glitch.MethodInfo__g0__t4, ptr %object, i32 0, i32 9
  %field_9 = load ptr, ptr %field_9_ptr
  %t48 = icmp eq ptr %field_9, null
  br i1 %t48, label %array_release_done_22, label %array_release_21
array_release_21:
  %t49 = getelementptr inbounds %glitch.array, ptr %field_9, i32 0, i32 0
  %t51 = getelementptr inbounds %glitch.array, ptr %field_9, i32 0, i32 1
...
array_release_done_22:
  ...
  %field_4 = load ptr, ptr %field_4_ptr
  %t53 = icmp eq ptr %field_4, null
  br i1 %t53, label %array_release_done_24, label %array_release_23
array_release_23:
  %t54 = getelementptr inbounds %glitch.array, ptr %field_4, i32 0, i32 0
  %t56 = getelementptr inbounds %glitch.array, ptr %field_4, i32 0, i32 1
...
element_drop_body_26:
  ...
  call void @glitch_drop_ParameterInfo__g0__t6(ptr %t62)
  %t63 = add i64 %t59, 1
...
entry:
  ...
  %t64 = icmp eq ptr %field_12, null
  br i1 %t64, label %array_release_done_29, label %array_release_28
array_release_28:
  %t65 = getelementptr inbounds %glitch.array, ptr %field_12, i32 0, i32 0
  %t67 = getelementptr inbounds %glitch.array, ptr %field_12, i32 0, i32 1
...
array_release_done_44:
  ...
  %t108 = icmp eq ptr %field_15, null
  br i1 %t108, label %array_release_done_49, label %array_release_48
array_release_48:
  %t109 = getelementptr inbounds %glitch.array, ptr %field_15, i32 0, i32 0
  %t111 = getelementptr inbounds %glitch.array, ptr %field_15, i32 0, i32 1
...
element_drop_body_51:
  ...
  call void @glitch_drop_PropertyInfo__g0__t8(ptr %t117)
  %t118 = add i64 %t114, 1
...
array_release_done_49:
  ...
  %t119 = icmp eq ptr %field_17, null
  br i1 %t119, label %array_release_done_54, label %array_release_53
array_release_53:
  %t120 = getelementptr inbounds %glitch.array, ptr %field_17, i32 0, i32 0
  %t122 = getelementptr inbounds %glitch.array, ptr %field_17, i32 0, i32 1
...
element_drop_body_56:
  ...
  call void @glitch_drop_FieldInfo__g0__t7(ptr %t128)
  %t129 = add i64 %t125, 1
...
element_drop_done_57:
  ...
  br label %array_release_done_54
array_release_done_54:
...
define void @NumberAlgorithmsTests__g0__t57_BubbleSort_OrdersValues__g0(ptr %this) {
entry:
  %t0 = alloca ptr
  store ptr %this, ptr %t0
  %t1 = alloca ptr
  store ptr null, ptr %t1
  %t2 = call ptr @NumberAlgorithms__g0__t56_BuildSample__g0()
  %t3 = load ptr, ptr @glitch_exception_pending
  %t4 = icmp ne ptr %t3, null
  br i1 %t4, label %exception_unwind, label %call_continue_0
call_continue_0:
...
collection_release_done_2:
  store ptr %t2, ptr %t1
  %t11 = load ptr, ptr %t1
  %t12 = getelementptr inbounds %glitch.list, ptr %t11, i32 0, i32 2
  %t13 = load ptr, ptr %t12
  %t14 = getelementptr inbounds i32, ptr %t13, i64 0
  ...
  store i64 5, ptr %t22
  %t23 = getelementptr %glitch.Box_int, ptr null, i32 1
  %t24 = ptrtoint ptr %t23 to i64
  %t25 = call ptr @glitch_calloc(i64 1, i64 %t24)
  %t26 = getelementptr inbounds %glitch.Box_int, ptr %t25, i32 0, i32 0
  store i64 1, ptr %t26
  %t27 = getelementptr inbounds %glitch.Box_int, ptr %t25, i32 0, i32 1
  store ptr @glitch_destroy_boxed_scalar, ptr %t27
  %t28 = getelementptr inbounds %glitch.Box_int, ptr %t25, i32 0, i32 2
  store i32 4, ptr %t28
  %t29 = getelementptr inbounds %glitch.Box_int, ptr %t25, i32 0, i32 3
  store i32 %t15, ptr %t29
  call void @Assert__g0__t54_Equal__g1__T_T(ptr %t18, ptr %t25)
  %t30 = load ptr, ptr @glitch_exception_pending
  %t31 = icmp ne ptr %t30, null
  br i1 %t31, label %exception_unwind, label %call_continue_3
call_continue_3:
  call void @glitch_box_release(ptr %t18)
  call void @glitch_box_release(ptr %t25)
  %t32 = load ptr, ptr %t1
  %t33 = icmp eq ptr %t32, null
  br i1 %t33, label %collection_release_done_5, label %collection_release_4
...
exception_unwind:
  ...
  br i1 %t39, label %collection_release_done_7, label %collection_release_6
collection_release_6:
  %t40 = getelementptr inbounds %glitch.list, ptr %t38, i32 0, i32 0
  %t41 = getelementptr inbounds %glitch.list, ptr %t38, i32 0, i32 2
...
call_continue_0:
  ...
  %t9 = load ptr, ptr @glitch_exception_pending
  %t10 = icmp ne ptr %t9, null
  br i1 %t10, label %exception_unwind, label %call_continue_1
call_continue_1:
  %t11 = call i64 @GlitchLiveAllocations_Load()
  %t12 = icmp ne i64 %t11, 0
  %t13 = load ptr, ptr @glitch_exception_pending
  %t14 = icmp ne ptr %t13, null
  %t15 = or i1 %t12, %t14
  %t16 = zext i1 %t15 to i32
  %t17 = call ptr @getenv(ptr @.env_report_leaks)
  %t18 = icmp ne ptr %t17, null
  br i1 %t18, label %report_leaks_2, label %main_return_3
report_leaks_2:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([6 x i8], ptr @.fmt_i64, i64 0, i64 0), i64 %t11)
  br label %main_return_3
main_return_3:
  ret i32 %t16
exception_unwind:
  %t19 = call i64 @GlitchLiveAllocations_Load()
  %t20 = icmp ne i64 %t19, 0
  %t21 = load ptr, ptr @glitch_exception_pending
  %t22 = icmp ne ptr %t21, null
  %t23 = or i1 %t20, %t22
  %t24 = zext i1 %t23 to i32
  %t25 = call ptr @getenv(ptr @.env_report_leaks)
  %t26 = icmp ne ptr %t25, null
  br i1 %t26, label %report_leaks_4, label %main_return_5
report_leaks_4:
  call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([6 x i8], ptr @.fmt_i64, i64 0, i64 0), i64 %t19)
...
entry:
  ret ptr getelementptr inbounds ({ i64, i64, [4 x i8] }, ptr @.str.28, i32 0, i32 2, i64 0)
}
